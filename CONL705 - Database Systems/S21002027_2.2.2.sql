...
CREATE TABLE AUTHOR 
(AUTHOR_NUM NUMBER(4) CONSTRAINT AUTHOR_PK PRIMARY KEY,
AUTHOR_LAST VARCHAR2(12),
AUTHOR_FIRST VARCHAR2(10) );

CREATE TABLE PUBLISHER 
(PUBLISHER_CODE CHAR(3) CONSTRAINT PUBLISHER_PK PRIMARY KEY,
PUBLISHER_NAME VARCHAR2(25),
CITY CHAR(20) );

CREATE TABLE BOOK 
(BOOK_CODE CHAR(4) CONSTRAINT BOOK_PK PRIMARY KEY,
TITLE VARCHAR2(40),
PUBLISHER_CODE CHAR(3),
TYPE CHAR(3),
PRICE DECIMAL(6,2),
PAPERBACK CHAR(1), 
CONSTRAINT BOOK_FK_PUBLISHER FOREIGN KEY (PUBLISHER_CODE) REFERENCES PUBLISHER (PUBLISHER_CODE));


CREATE TABLE BRANCHES 
(BRANCH_NUM NUMBER(2) CONSTRAINT BRANCH_PK PRIMARY KEY,
...
(BOOK_CODE CHAR(4) CONSTRAINT INVENTORY_FK_BOOK  REFERENCES BOOK (BOOK_CODE),
BRANCH_NUM NUMBER(2) CONSTRAINT INVENTORY_FK_BRANCH REFERENCES BRANCHES(BRANCH_NUM),
ON_HAND NUMBER(4),
CONSTRAINT INVENTORY_PK PRIMARY KEY (BOOK_CODE, BRANCH_NUM));

CREATE TABLE WROTE 
(BOOK_CODE CHAR(4) CONSTRAINT WROTE_FK_BOOK REFERENCES BOOK (BOOK_CODE),
AUTHOR_NUM NUMBER(2)CONSTRAINT WROTE_FK_AUTHOR REFERENCES AUTHOR(AUTHOR_NUM),
SEQUENCE NUMBER(2),
CONSTRAINT WROTE_PK PRIMARY KEY (BOOK_CODE, AUTHOR_NUM));
